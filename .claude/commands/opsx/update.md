...
4. **Read and reconcile**
   ...
   - Note everything that is now inconsistent, missing, or contradictory - each one grounded in specific text you actually read in the artifacts (quote or point to the line), not a vague impression. If you're not sure something is actually a conflict, re-read before flagging it rather than guessing.
...
- Don't invent - every inconsistency, gap, or contradiction you flag must trace back to specific text you actually read this session; when unsure, re-read the artifact rather than assume
