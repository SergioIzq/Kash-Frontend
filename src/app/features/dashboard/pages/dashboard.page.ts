                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex flex-col gap-3">
                            @for (alerta of dashboardStore.resumen()!.alertas; track alerta.titulo) {
                                <div [class]="'card p-4 border-l-4 shadow-1 ' + getAlertaClass(alerta.tipo)">
                                    <div class="flex items-center gap-4">
                                        <span class="text-3xl">{{ alerta.icono || '⚠️' }}</span>
                                        <div class="flex-1">
                                            <div class="font-bold text-lg mb-1">{{ alerta.titulo }}</div>
                                            <div class="text-700 leading-normal">{{ alerta.mensaje }}</div>
                                        </div>
                                    </div>
                                </div>
                            }
                        ...
                        <div class="card shadow-2 p-0 overflow-hidden surface-card">
                            <div class="p-4 border-b surface-border bg-gray-50 flex justify-between items-center">
                                <div class="flex flex-col">
                                    ...
                                    <span class="text-sm text-500 mt-1">Promedio mensual necesario para cubrir tus gastos según tu histórico.</span>
                                </div>
                            </div>
                                    ...
                                    @for (anio of dashboardStore.presupuestoAnual(); track anio.anio; let first = $first) {
                                        <div [class]="'p-4 hover:surface-hover transition-colors grid grid-cols-1 md:grid-cols-3 gap-4 items-center ' + (first ? 'bg-blue-50/50' : '')">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div class="font-bold text-xl text-900">Año {{ anio.anio }}</div>
                                                    <div class="text-sm text-500">{{ anio.mesesRegistrados }} meses registrados</div>
                                                </div>
                                            </div>
