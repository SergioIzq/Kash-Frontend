...
El sistema SHALL ofrecer una vista de captura reducida en la que concepto e importe son los únicos campos visibles por defecto, con el resto de campos (cuenta, forma de pago, categoría, proveedor/persona) precargados mediante sugerencia y presentados como un resumen editable en lugar de campos abiertos.
...
- **THEN** el sistema muestra un resumen con cuenta, forma de pago y categoría ya rellenados a partir del histórico de ese concepto, permite guardar la transacción sin más pasos, y permite pulsar "cambiar" para editar cualquiera de esos campos antes de guardar
